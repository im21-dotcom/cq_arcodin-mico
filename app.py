...
st.title("📋 Cálculo de Dose - Controle de Qualidade de Paciente Específico")

with st.form("formulario"):
    st.header("Dados do Paciente")
    nome = st.text_input("Nome completo do paciente")
    num_id = st.text_input("Número de ID do paciente")
    ...
    num_campos = st.number_input("Número de campos", min_value=1, step=1)
...
if enviado:
    ...
    with open(nome_arquivo, "rb") as f:
        ...
        st.download_button("📥 Clique aqui para baixar o PDF", f, file_name=nome_arquivo, mime="application/pdf")
